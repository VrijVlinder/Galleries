...
if($UserHasPermission) {
	...
	if(isset($_POST['PGUpload'])){
		...
		if(isset($theFile['small'])){
			...
			if(is_array($gogo)) echo $gogo[0]; else echo '<b><h3>Success File has been uploaded!... </h3></b></br><a href="/forum/gallery" title="Go Back To Main Gallery to view image">Go Back to main Gallery</a>....</br>';
		} else {
